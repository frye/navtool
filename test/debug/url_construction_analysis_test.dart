...
void main() {
  group('NOAA URL Configuration Analysis', () {
    test('should identify the URL construction issue', () {
      ...
      print('- Result: "https://charts.noaa.govhttps://gis.charttools.noaa.gov/..."');
      print('');
      ...
      print('- Use relative path "/arcgis/rest/services/encdirect/enc_coverage/MapServer/0/query"');
      print('');
      
      // Verify this is indeed wrong
      expect(catalogEndpoint, startsWith('https://'), 
             reason: 'Catalog endpoint is a full URL');
      
      expect(downloadBase, startsWith('https://'),
             reason: 'Download base is a full URL');
      
      print('🎯 ROOT CAUSE IDENTIFIED:');
      print('The NavTool application IS using production endpoints,');
      print('but the URL construction is BROKEN due to baseUrl + fullUrl concatenation!');
      print('');
