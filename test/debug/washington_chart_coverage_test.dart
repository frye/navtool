...
void main() {
  group('Washington Chart Coverage Analysis', () {
    ...
    test('should analyze why no charts cover Washington coordinates', () async {
      ...
      print('Seattle within Washington bounds: ${_pointInBounds(seattleLat, seattleLon, washingtonBounds)}');
      print('');
      ...
      final testCharts = [
        ...
        Chart(
          ...
          scale: 80000,
          bounds: GeographicBounds(north: 71.0, south: 54.0, east: -130.0, west: -170.0),
        ...
        Chart(
          ...
          title: 'Bering Sea 1',
          scale: 100000,
          bounds: GeographicBounds(north: 66.0, south: 53.0, east: -158.0, west: -180.0),
          lastUpdate: DateTime.now(),
          state: 'Alaska',
          type: ChartType.general,
        ),
        ...
        Chart(
          ...
          scale: 80000,
          bounds: GeographicBounds(north: 48.5, south: 46.0, east: -123.5, west: -124.8), // Should cover WA coast
          lastUpdate: DateTime.now(),
          state: 'Washington',
          type: ChartType.general,
        ),
        ...
        Chart(
          ...
          scale: 80000,
          bounds: GeographicBounds(north: 46.5, south: 44.5, east: -123.8, west: -124.5), // OR/WA border
          lastUpdate: DateTime.now(),
          state: 'Oregon',
          type: ChartType.general,
        ),
        ...
        Chart(
          ...
          scale: 80000,
          bounds: GeographicBounds(north: 39.0, south: 37.0, east: -122.0, west: -123.8), // California
          lastUpdate: DateTime.now(),
          state: 'California',
          type: ChartType.general,
        ),
        ...
        Chart(
          ...
          scale: 500000,
          bounds: GeographicBounds(north: 22.5, south: 18.5, east: -154.0, west: -161.0),
          lastUpdate: DateTime.now(),
          state: 'Hawaii',
          type: ChartType.general,
        ),
        ...
        Chart(
          ...
          scale: 1000000,
          bounds: GeographicBounds(north: 60.0, south: 20.0, east: -120.0, west: -180.0),
          lastUpdate: DateTime.now(),
          state: 'Pacific',
      ...
      for (final chart in testCharts) {
        ...
        final coversSeattle = _pointInBounds(seattleLat, seattleLon, chart.bounds);
      ...
      final seattleBounds = GeographicBounds(
        north: seattleLat + 0.1, south: seattleLat - 0.1,
        east: seattleLon + 0.1, west: seattleLon - 0.1
      );
      ...
      if (chartsInWashington.isEmpty) {
        ...
        print('This explains why the app shows 0 charts for Washington selection.');
        
        // Check if any West Coast charts exist
        final westCoastCharts = testCharts.where((c) => c.id.contains('WC')).toList();
      ...
      expect(chartsInWashington.any((c) => c.id == 'US1WC01M'), isTrue,
             reason: 'US1WC01M should cover Washington coast and be found by spatial query');
    });
  });
}
