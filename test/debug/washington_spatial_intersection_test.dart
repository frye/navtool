...
void main() {
  group('Washington State Spatial Intersection Diagnostic', () {
    test('should analyze why Washington charts are not found', () {
      ...
      final washingtonPolygon = SpatialOperations.boundsToPolygon(
        washingtonBounds,
      );
      final isSeattleInWashington = SpatialOperations.isPointInPolygon(
        seattleCoords,
        washingtonPolygon,
      );

      print(
        '✅ Seattle coordinates: ${seattleCoords.latitude}, ${seattleCoords.longitude}',
      );
      print(
        '✅ Washington bounds: N:${washingtonBounds.north} S:${washingtonBounds.south} E:${washingtonBounds.east} W:${washingtonBounds.west}',
      );
      ...
      final chart1Intersects = SpatialOperations.doPolygonsIntersect(
        washingtonPolygon,
        chart1Polygon,
      );
      final chart1Coverage = SpatialOperations.calculateCoveragePercentage(
        washingtonPolygon,
        chart1Polygon,
      );
      ...
      print(
        '  Bounds: N:${westCoastChart1.north} S:${westCoastChart1.south} E:${westCoastChart1.east} W:${westCoastChart1.west}',
      );
      ...
      final chart2Intersects = SpatialOperations.doPolygonsIntersect(
        washingtonPolygon,
        chart2Polygon,
      );
      final chart2Coverage = SpatialOperations.calculateCoveragePercentage(
        washingtonPolygon,
        chart2Polygon,
      );
      ...
      print(
        '  Bounds: N:${westCoastChart2.north} S:${westCoastChart2.south} E:${westCoastChart2.east} W:${westCoastChart2.west}',
      );
      ...
      // Basic assertions
      expect(
        isSeattleInWashington,
        isTrue,
        reason: 'Seattle should be in Washington',
      );
      expect(
        washingtonPolygon.length,
        greaterThanOrEqualTo(3),
        reason: 'Washington polygon should have at least 3 vertices',
      );
    });
    ...
    test('should test actual chart bounds extraction issue', () {
      ...
      final invalidBounds1 = GeographicBounds(
        north: 0,
        south: 0,
        east: 0,
        west: 0,
      );
      final invalidBounds2 = GeographicBounds(
        north: -1,
        south: 1,
        east: -1,
        west: 1,
      ); // Invalid (north < south)
      final validBounds = GeographicBounds(
        north: 48.0,
        south: 47.0,
        east: -122.0,
        west: -123.0,
