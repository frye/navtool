...
void main() {
  group('Real NOAA Chart Bounds Analysis', () {
    test(
      'should analyze actual NOAA API response pattern and explain Washington coverage gap',
      () async {
        ...
        final realNoaaCharts = [
          ...
          {
            'id': 'US1EEZ1M',
            'title': 'Economic Exclusion Zone 1',
            'state': 'Pacific',
          },
          {
            'id': 'US1EEZ2M',
            'title': 'Economic Exclusion Zone 2',
            'state': 'Pacific',
          },
          {
            'id': 'US1EEZ3M',
            'title': 'Economic Exclusion Zone 3',
            'state': 'Pacific',
          },
        ...
        final westCoastCharts = realNoaaCharts
            .where(
              (chart) =>
        ...
        print(
          'Potential Washington coverage charts: ${westCoastCharts.length}',
        );
        ...
        print(
          '4. ❌ This suggests the West Coast charts don\'t actually cover Washington',
        );
        print('');
        ...
        print(
          '   - West Coast charts might cover California/Oregon but not Washington',
        );
        print('');
        ...
        print(
          '   - US1WC01M, US1WC04M, US1WC07M might not reach Washington waters',
        );
        ...
        print(
          'The issue is NOT with our cache invalidation (which works correctly)',
        );
        ...
        expect(
          westCoastCharts.length,
          greaterThan(0),
          reason: 'Should have some West Coast charts',
        );
        ...
        print('');
        print(
          '🎯 SOLUTION: Use production NOAA API or add test Washington charts',
        );
      },
