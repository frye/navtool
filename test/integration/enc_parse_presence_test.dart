...
void main() {
  group('ENC Parse Presence Tests', () {
    ...
    testWidgets('should assert presence of critical feature classes using test data', 
        (tester) async {
      ...
      expect(syntheticFrequencies, isNotEmpty, 
    ...
    testWidgets('should handle missing fixtures gracefully', (tester) async {
      if (!fixtures.hasAnyFixtures) {
        ...
        print('Set NOAA_ENC_FIXTURES environment variable to enable real data tests');
