...
void main() {
  group('NOAA API Integration Tests', () {
    ...
    group('End-to-End NOAA Operations', () {
      test(
        'should fetch catalog with rate limiting and circuit protection',
        () async {
          // Arrange
      ...
      test(
        'should handle download with progress tracking and resilience',
        () async {
          // Arrange
          final mockHttpClient = MockHttpClientService();
          final mockLogger = MockAppLogger();
    ...
    group('Performance and Marine Environment', () {
      test('should handle marine environment requirements', () {
        ...
        expect(
          ...
          3,
        ); // Conservative for poor connectivity
        expect(
          apiPolicy.maxRetries,
      ...
      test('should demonstrate concurrent request handling', () async {
        ...
        expect(
          results.every(
            (r) => r.startsWith('success') || r.startsWith('delayed'),
          ),
          isTrue,
        );
      });
