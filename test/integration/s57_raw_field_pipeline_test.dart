...
void main() {
  group('S57 Raw Field Pipeline Integration', () {
    ...
    test(
      'should parse records and identify candidate feature-bearing fields',
      () {
    ...
    test(
      'should successfully extract and process field data through pipeline',
      () {
        final records = reader.readAll().toList();
...
List<Map<String, dynamic>> _processRawFieldPipeline(
  List<Iso8211Record> records,
) {
