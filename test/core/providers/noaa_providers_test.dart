  ...
  group('NOAA Providers Registration Tests', () {
    ...
    group('Circuit Breaker Provider', () {
      ...
      test('should configure circuit breaker for marine environments', () {
        ...
        // Assert
        expect(circuitBreaker.failureThreshold, 3); // Conservative for marine networks
        expect(circuitBreaker.timeout.inMinutes, greaterThanOrEqualTo(2)); // Marine timeout
      });
    });
    ...
    group('Provider Singletons', () {
      ...
      test('should create separate instances for retry policies', () {
        ...
        expect(apiPolicy1.maxRetries != downloadPolicy.maxRetries ||
               apiPolicy1.maxDelay != downloadPolicy.maxDelay, isTrue);
        expect(downloadPolicy.maxRetries != criticalPolicy.maxRetries ||
               downloadPolicy.maxDelay != criticalPolicy.maxDelay, isTrue);
      });
    });
    ...
    group('Cross-Provider Dependencies', () {
      ...
      test('should maintain consistency across provider reads', () {
        ...
        final discoveryService2 = container.read(noaaChartDiscoveryServiceProvider);
...
class MockNoaaApiClient implements NoaaApiClient {
  ...
  @override
  Future<void> downloadChart(String cellName, String savePath, {NoaaProgressCallback? onProgress}) async {}
