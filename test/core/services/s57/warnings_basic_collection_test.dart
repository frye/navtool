...
void main() {
  group('S57 Warnings Basic Collection', () {
    ...
    test('should support filtering by severity', () {
      ...
      final warnings = collector.getWarningsBySeverity(
        S57WarningSeverity.warning,
      );
    ...
    test('should support filtering by code', () {
      ...
      final unknownCodeWarnings = collector.getWarningsByCode(
        S57WarningCodes.unknownObjCode,
      );
      final fieldBoundsWarnings = collector.getWarningsByCode(
        S57WarningCodes.fieldBounds,
      );
    ...
    test('should handle timestamp generation correctly', () {
      ...
      expect(
        warning.timestamp.isAfter(beforeTime) ||
            warning.timestamp.isAtSameMomentAs(beforeTime),
        isTrue,
      );
      expect(
        warning.timestamp.isBefore(afterTime) ||
            warning.timestamp.isAtSameMomentAs(afterTime),
        isTrue,
      );
    });
  });
