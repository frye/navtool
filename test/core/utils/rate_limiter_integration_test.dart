...
void main() {
  group('Rate Limiter Integration Tests', () {
    test(
      'should integrate with HTTP client service for NOAA requests',
      () async {
        // Arrange
        ...
        expect(
          ...
          0,
        ); // All should be accepted but rate limited
    ...
    test(
      'should demonstrate rate limiting preventing server overload',
      () async {
        // Arrange
    ...
    test('should handle burst traffic gracefully', () async {
      ...
      for (int i = 3; i < 6; i++) {
        additionalRequests.add(
          _makeRateLimitedRequest(rateLimiter, metrics, i),
        );
      }
