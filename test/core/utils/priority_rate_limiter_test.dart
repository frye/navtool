  ...
  group('PriorityRateLimiter Tests', () {
    ...
    group('Capacity Reservation', () {
      test('should reserve capacity for specific priorities', () {
        ...
        // Act & Assert
        expect(() => rateLimiter.reserveCapacity(RequestPriority.critical, 2), 
               returnsNormally);
    ...
    group('Integration', () {
      test('should work with base rate limiter functionality', () async {
        ...
        await rateLimiter.acquireWithPriority(RequestPriority.critical); // Use priority method
