  ...
  group('MacosStatusBar Widget Tests', () {
    testWidgets('should display status text correctly', (
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: MacosStatusBar(statusText: statusText)),
        ),
      );
    ...
    testWidgets('should have correct height and styling', (
      WidgetTester tester,
    ) async {
      // Act
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: MacosStatusBar(statusText: 'Test status')),
        ),
      );
    ...
    testWidgets('should use appropriate macOS theming', (
      WidgetTester tester,
    ) async {
      // Act
      await tester.pumpWidget(
        MaterialApp(
          ...
          home: const Scaffold(body: MacosStatusBar(statusText: 'Test status')),
        ),
      );
    ...
    testWidgets('should handle empty status text', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: MacosStatusBar(statusText: '')),
        ),
      );
    ...
    testWidgets('should handle long status text with ellipsis', (
      WidgetTester tester,
    ) async {
      // Arrange
      const longStatusText =
          'This is a very long status text that should be truncated with ellipsis when the status bar width is limited';
    ...
    testWidgets('should position at bottom of layout', (
      WidgetTester tester,
    ) async {
      // Act
      await tester.pumpWidget(
      ...
      // Assert
      final statusBarPosition = tester.getBottomLeft(
        find.byType(MacosStatusBar),
      );
      final mainContentPosition = tester.getBottomLeft(
