...
void main() {
  group('AppIcon Widget Tests', () {
    Widget createTestWidget({Widget? child}) {
      return MaterialApp(home: Scaffold(body: child ?? const AppIcon()));
    }
    ...
    testWidgets('should accept custom size', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        createTestWidget(child: const AppIcon(size: customSize)),
      );
      await tester.pumpAndSettle();
    ...
    group('Platform-specific Icon Tests', () {
      testWidgets('should use macOS style icon on macOS platform', (
        WidgetTester tester,
      ) async {
        // Arrange
        ...
        final svgPicture = tester.widget<SvgPicture>(find.byType(SvgPicture));
        expect(
          svgPicture.bytesLoader.toString(),
          contains('app_icon_macos_sailboat.svg'),
        );
      ...
      testWidgets('should use standard icon on non-macOS platforms', (
        WidgetTester tester,
      ) async {
        // Arrange
    ...
    group('Apple-style Icon Content Tests', () {
      testWidgets('should have rounded rectangle boundary on macOS', (
        WidgetTester tester,
      ) async {
        // Arrange
        debugDefaultTargetPlatformOverride = TargetPlatform.macOS;
      ...
      testWidgets(
        'should contain sailboat-themed content within Apple boundary',
