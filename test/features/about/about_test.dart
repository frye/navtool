  ...
  group('About Feature Tests', () {
    Widget createTestWidget({Widget? child}) {
      return ProviderScope(
        child: MaterialApp(home: child ?? const AboutScreen()),
      );
    }

    group('About Screen Information Display', () {
      testWidgets('should display comprehensive about information', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
      ...
      testWidgets('should display application description', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
        ...
        expect(
          find.textContaining('Marine Navigation'),
    ...
    group('Version Information Accuracy', () {
      testWidgets('should display version information from package info', (
        WidgetTester tester,
      ) async {
        // Mock package info
      ...
      testWidgets('should show correct application name', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets('should handle version retrieval errors gracefully', (
        WidgetTester tester,
      ) async {
    ...
    group('License and Attribution Display', () {
      testWidgets('should display license information', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets('should display Flutter attribution', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets('should show open source acknowledgments', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
    ...
    group('Contact Information Presentation', () {
      testWidgets('should display contact or support information', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets('should provide feedback or support channels', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
    ...
    group('About Dialog Testing', () {
      testWidgets('should display AboutAppDialog correctly', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
      ...
      testWidgets('should display feature list in dialog', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(
    ...
    group('Links and External Navigation', () {
      testWidgets('should handle external link navigation safely', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets('should provide proper link affordances', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
    ...
    group('Marine Safety Disclaimers', () {
      testWidgets('should display appropriate marine safety disclaimers', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets('should warn about navigation aid limitations', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
    ...
    group('Legal Compliance Information', () {
      testWidgets('should display copyright information', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets('should show software license compliance', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
      ...
      testWidgets('should provide regulatory compliance information', (
        WidgetTester tester,
      ) async {
        // Arrange & Act
        await tester.pumpWidget(createTestWidget());
