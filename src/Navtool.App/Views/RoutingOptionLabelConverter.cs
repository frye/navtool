...
public sealed class RoutingOptionLabelConverter : IValueConverter
{
    ...
    public object Convert(object? value, Type targetType, object? parameter, CultureInfo culture) => value switch
    {
        ...
        EcmwfCacheMaximumAge.SixHours => "6 hours",
        EcmwfCacheMaximumAge.TwelveHours => "12 hours",
        EcmwfCacheMaximumAge.TwentyFourHours => "24 hours",
        EcmwfCacheMaximumAge.Forever => "Forever",
