...
class S57BackwardCompatibilityAdapter {
  ...
  static const Map<S57FeatureType, String> _legacyToAcronymMap = {
    ...
    S57FeatureType.buoyCardinal: 'BOYLAT', // Cardinal buoy -> Lateral buoy for compatibility
    ...
    S57FeatureType.depthContour: 'DEPARE', // Depth contour -> Depth area for compatibility
  ...
  static String legacyToAcronym(S57FeatureType legacyType) {
    ...
    if (!_warnedDeprecatedUsage.contains(legacyType)) {
      ...
      print('Warning: S57FeatureType.$legacyType is deprecated. '
  ...
  static S57ObjectClass? legacyToObjectClass(S57FeatureType legacyType, S57ObjectCatalog catalog) {
  ...
  static Map<String, int> getMappingStats() {
    return {
      ...
      'unknown_mappings': _legacyToAcronymMap.values.where((v) => v == 'UNKNOW').length,
    };
  }
}