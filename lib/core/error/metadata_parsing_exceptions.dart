...
class MissingRequiredFieldException extends MetadataParsingException {
  ...
  @override
  String toString() =>
      'MissingRequiredFieldException: Missing required field: $fieldName';
}
...
class DateParsingException extends MetadataParsingException {
  ...
  @override
  String toString() =>
      'DateParsingException: Failed to parse date: $dateString';
}
...
class InvalidChartScaleException extends MetadataParsingException {
  ...
  @override
  String toString() =>
      'InvalidChartScaleException: Invalid chart scale: $scale';
}
