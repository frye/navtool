      ...
      builder: (context) => AlertDialog(
        ...
        content: const Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text('• Using Windows-compatible GPS implementation'),
            Text('• Location service bypasses geolocator CMake issues'),
            Text('• Currently showing demo coordinates'),
            Text('• Real GPS integration coming soon'),
            SizedBox(height: 12),
