...
class _ChartScreenState extends State<ChartScreen> {
              ...
              children: [
                if (widget.chart != null) ...[
                  ...
                  _buildDiagnosticSection('Troubleshooting Steps', [
                    '1. Verify test data files exist in test/fixtures/charts/s57_data/',
  ...
  String? _getElliottBayTestPath(String chartId) {
    ...
    return switch (chartId) {
      'US5WA50M' => 'test/fixtures/charts/s57_data/US5WA50M_harbor_elliott_bay.zip',
      'US3WA01M' => 'test/fixtures/charts/s57_data/US3WA01M_coastal_puget_sound.zip',
      // Add other Elliott Bay chart variations
      'US5WA17M' => 'test/fixtures/charts/s57_data/US5WA50M_harbor_elliott_bay.zip', // Alias for harbor chart
      'US5WA18M' => 'test/fixtures/charts/s57_data/US3WA01M_coastal_puget_sound.zip', // Alias for approach chart
      _ => null,
    };
  }
